    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown(
                        options: [
                          FFLocalizations.of(context).getText(
                            'jislkk06' /* Office Budget */,
                          ),
                          FFLocalizations.of(context).getText(
                            'xguvuxmq' /* External Transfer */,
                          ),
                          FFLocalizations.of(context).getText(
                            'jnyllndo' /* ACH Payment */,
                          )
                        ].toList(),
          ...
          Text(
            FFLocalizations.of(context).getText(
              'd65vkkyp' /* Tap above to complete request */,
            ),

              ...
              children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          FFLocalizations.of(context).getText(
                            '845711ep' /* Choose what notifcations you w... */,
                          ),
                ...
                Padding(
                  ...
                  child: SwitchListTile.adaptive(
                    ...
                    title: Text(
                      FFLocalizations.of(context).getText(
                        'qcy2pu8s' /* Push Notifications */,
                      ),
                      style: FlutterFlowTheme.of(context).title3,
                    ),
                    subtitle: Text(
                      FFLocalizations.of(context).getText(
                        'qvbf4v4c' /* Receive Push notifications fro... */,
                      ),
                      style: FlutterFlowTheme.of(context).bodyText1,
                    ),
                ...
                SwitchListTile.adaptive(
                  ...
                  title: Text(
                    FFLocalizations.of(context).getText(
                      'u6eld1ro' /* Email Notifications */,
                    ),
                    style: FlutterFlowTheme.of(context).title3,
                  ),
                  subtitle: Text(
                    FFLocalizations.of(context).getText(
                      'u4ceus4f' /* Receive email notifications fr... */,
                    ),
                    style: FlutterFlowTheme.of(context).bodyText1,
                  ),
                  tileColor: Color(0xFFF5F5F5),
                ...
                SwitchListTile.adaptive(
                  ...
                  title: Text(
                    FFLocalizations.of(context).getText(
                      't1bckz3o' /* Location Services */,
                    ),
                    style: FlutterFlowTheme.of(context).title3,
                  ),
                  subtitle: Text(
                    FFLocalizations.of(context).getText(
                      'z29bq1x7' /* Allow us to track your locatio... */,
                    ),
                    style: FlutterFlowTheme.of(context).bodyText1,
                  ),
                  tileColor: Color(0xFFF5F5F5),

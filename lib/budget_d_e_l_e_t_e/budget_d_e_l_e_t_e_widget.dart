...
class BudgetDELETEWidget extends StatefulWidget {
  ...
  final DocumentReference dadoapagar;
...
class _BudgetDELETEWidgetState extends State<BudgetDELETEWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<BancoRecord>(
      stream: BancoRecord.getDocument(widget.dadoapagar),
        ...
        return Scaffold(
          ...
          body: Column(
            ...
            children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'qyz4e6ls' /* If you delete this budget, you... */,
                                  ),
                        ...
                        StreamBuilder<List<BancoRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return FFButtonWidget(
                              onPressed: () async {
                                await widget.dadoapagar.delete();
              ...
              Text(
                FFLocalizations.of(context).getText(
                  'pdjqtszw' /* Tap above to remove this bude */,
                ),

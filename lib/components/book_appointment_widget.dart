              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'lcx6u3yo' /* Fill out the information below... */,
                            ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'ycxnt50w' /* Emails will be sent to: */,
                      ),
                      style: FlutterFlowTheme.of(context).bodyText1,
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown(
                      options: [
                        FFLocalizations.of(context).getText(
                          'crtqlzi7' /* Type of Appointment */,
                        ),
                        FFLocalizations.of(context).getText(
                          'h11ola3a' /* Doctors Visit */,
                        ),
                        FFLocalizations.of(context).getText(
                          'r9v2tox0' /* Routine Checkup */,
                        ),
                        FFLocalizations.of(context).getText(
                          '55nfo9k6' /* Scan/Update */,
                        )
                      ].toList(),

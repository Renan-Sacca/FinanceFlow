                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'gjknnz8o' /* Fill out the information below... */,
                            ),
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown(
                      options: [
                        FFLocalizations.of(context).getText(
                          '5ezlis5w' /* Type of Appointment */,
                        ),
                        FFLocalizations.of(context).getText(
                          'rlrdvf3f' /* Doctors Visit */,
                        ),
                        FFLocalizations.of(context).getText(
                          'awvws38b' /* Routine Checkup */,
                        ),
                        FFLocalizations.of(context).getText(
                          'd21iadma' /* Scan/Update */,
                        )
                      ].toList(),

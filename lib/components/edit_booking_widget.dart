          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'u99sjqqn' /* Edit the fields below in order... */,
                        ),
              ...
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'qye0gm3s' /* Emails will be sent to: */,
                  ),
                  style: FlutterFlowTheme.of(context).bodyText1,
                ),
              ),
              ...
              Padding(
                ...
                child: FlutterFlowDropDown(
                  ...
                  options: [
                    FFLocalizations.of(context).getText(
                      'wdbteh3y' /* Type of Appointment */,
                    ),
                    FFLocalizations.of(context).getText(
                      'dnkvgal2' /* Doctors Visit */,
                    ),
                    FFLocalizations.of(context).getText(
                      'n44oyvua' /* Routine Checkup */,
                    ),
                    FFLocalizations.of(context).getText(
                      'ozm6kjjc' /* Scan/Update */,
                    )
                  ].toList(),

      ...
      body: Form(
        ...
        child: Column(
          ...
          children: [
                            ...
                            validator: (val) {
                              if (val == null || val.isEmpty) {
                                return FFLocalizations.of(context).getText(
                                  'xzhemtfq' /* Please enter an amount */,
                                );
                              }
            ...
            Text(
              FFLocalizations.of(context).getText(
                '3zzz8kxj' /* Tap above to complete request */,
              ),

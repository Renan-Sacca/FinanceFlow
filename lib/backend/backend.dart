...
Stream<List<BancoRecord>> queryBancoRecord(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(BancoRecord.collection, BancoRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
...
Future<List<BancoRecord>> queryBancoRecordOnce(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(BancoRecord.collection, BancoRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
...
Stream<List<CreditoDetalheRecord>> queryCreditoDetalheRecord(
        ...
        bool singleRecord = false}) =>
    queryCollection(
        CreditoDetalheRecord.collection, CreditoDetalheRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

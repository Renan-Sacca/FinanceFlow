                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'u5bgh2j1' /* Create your account below. */,
                                      ),
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'xgw9it6n' /* Don't have an account? */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyText1,
                                        ),
